...
<body>
  ...
  <h1>Freshmeal Gallery</h1>
  <div class="wrapper">
    <div class="box item-1"><img src="<?php echo base_url() ?>images/img1.jpg" alt="">
