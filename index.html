    ...
    <div class="site-wrapper">
        <header>
            <nav class="navbar navbar-expand-lg navbar-dark">
                <a class="navbar-brand" href="index.html" style="font-family: Skranji, cursive; color: black;"><img class="myImg" src="robomotz logo-02.png"></a>
...
<div class="row my-4">
    <div class="col-md-4 offset-md-2">
        <div class="card" style="width: 18rem;">
            ...
            <div class="card-body">
              <a class="a2" href="News & Events.html" class="card-link">Learn more</a>
            </div>
          </div>
    </div>
    <div class="col-md-4">
...
<section class="section-2">
  <div class="card">
    <div class="card-body text-center">
      ...
      <p class="card-text"><small class="text-muted"><a class="a1" href="Videos.html">Embark on a journey into the world of Assassin's Creed</a></small></p>
    </div>
